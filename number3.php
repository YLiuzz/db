...
<!-- <form>
	<p>供應商名稱 <input type="text" name="num1" placeholder="供應商名稱"></p>
	<p>供應商編號 <input type="text" name="num2" placeholder="供應商編號"></p>
	<p>供應商負責人<input type="text" name="num3" placeholder="供應商負責人"></p>
	<p>進貨品名<input type="text" name="num4" placeholder="進貨品名"></p>
	<p>進貨數量 <input type="text" name="num5" placeholder="進貨數量"></p>
	<p>進貨單位 <input type="text" name="num6" placeholder="進貨單位"></p>
	<p>進貨單價 <input type="text" name="num7" placeholder="進貨單價"></p>
	<p>小計 <input type="text" name="num8" placeholder="小計"></p>
	<p>庫存位置 <input type="text" name="num9" placeholder="庫存位置"></p>
	<p>規格 <input type="text" name="num10" placeholder="規格"></p>
	<p>進貨日期 <input type="text" name="num11" placeholder="進貨日期"></p>
